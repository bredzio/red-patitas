                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0px 15px 15px 15px;word-break:break-word;">
                      ...
                      <div
                        ...
                        <p style="text-align: center;margin: 0 0 25px 0;"><span style="font-size: 16px;">Has recibido un nuevo mensaje:</span></p>
                        <p style="text-align: center;margin: 0 0 25px 0;"><span style="font-size: 16px;">${message}</span></p>
                      </div>
